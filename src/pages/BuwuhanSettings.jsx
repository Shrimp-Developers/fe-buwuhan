...
export default function BuwuhanSettingsUser() {
    return (
        <div className="w-full mx-auto px-3 sm:px-4 md:px-5">
            ...
            <div className="space-y-2.5 sm:space-y-3">
                ...
                <Link to="/dashboard/settings/update-password" className="w-full flex items-center justify-between px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 border border-[#000000] rounded-full bg-white hover:bg-gray-50 transition">
                    <div className="flex items-center gap-2 sm:gap-2.5">
                        <img
                            src="/icon-key.png"
